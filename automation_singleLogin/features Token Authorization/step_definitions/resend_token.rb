Dado('que eu crie um login para reenvio de token') do
  @body = {
...
@post_createLogin = CreateLogin_KnowToken.post('/singleLogin/v2/createLogin' , body: @body)
...
@put_checkAccount1 = CheckAccount.put('/singleLogin/v1/checkAccount' , body: @checkAccount1)
...
@put_checkAccount2 = CheckAccount.put('/singleLogin/v1/checkAccount' , body: @checkAccount2)
...
@put_checkAccount3 = CheckAccount.put('/singleLogin/v1/checkAccount' , body: @checkAccount3)
...
@put_checkAccount4 = CheckAccount.put('/singleLogin/v1/checkAccount' , body: @checkAccount4)
